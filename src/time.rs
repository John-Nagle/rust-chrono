...
impl<Tz: TimeZone> Time<Tz> where Tz::Offset: fmt::String {
...
impl<Tz: TimeZone> fmt::Show for Time<Tz> {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "{:?}{:?}", self.naive_local(), self.offset)
    }
}

impl<Tz: TimeZone> fmt::String for Time<Tz> where Tz::Offset: fmt::String {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "{}{}", self.naive_local(), self.offset)
    }
}
